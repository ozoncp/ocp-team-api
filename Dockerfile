...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-team-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-team-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-team-api/bin/ocp-team-api .
RUN chown root:root ocp-team-api
EXPOSE 8082
CMD ["./ocp-team-api"]